 ...
 * 
 * dIrei meglio cheThis macro analyze objects divided in arbitraty number of categories (lables, object prediction) and regions (ROIs). The output report the classification of each cell 
