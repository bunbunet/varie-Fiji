...
run("Select None");
// get the number of labels from the maximum gray value
...
for (i = 1; i <= Labels; i++) {
	...
	//ask user to select the labels that will be retained
	Name=getString("Object name", " ");
	SelectObject=getBoolean("Do you want to select specific objects?");
